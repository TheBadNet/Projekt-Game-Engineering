...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	if (!RegisterClassEx(&wcex))  {
		MessageBox(NULL, TEXT("Call to RegisterClassEx failed!"), TEXT("VektoriaV9App"), NULL);
		return 1;
	}
	...
	if (!hWnd) 
	{
		MessageBox(NULL, TEXT("CreateWindow failed!"), TEXT("VektoriaApp"), NULL);
		return 1;
	}
